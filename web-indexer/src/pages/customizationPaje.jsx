...
function HeroSection(){
    ...
    return <div className="flex flex-col items-center justify-center w-full text-center ">

 
            {/* <Heading/> */}
            {/* <SubHeading/> */}
            <div className="flex flex-col justify-center w-full gap-10 pt-10 md:flex-row md:flex-wrap md:gap-2 ">
                <div className="pt-14 p-6 md:p-14 rounded-2xl flex flex-col items-start justify-start md:w-max w-full md:max-w-[60%] text-left h-[95vh] overflow-y-scroll bg-[#101015] border-[#27272A99] ">{/* bg-[#3232327d] bg-[#0d0d10]*/}
                    <div className="text-3xl font-medium md:text-2xl">Configure ChatBot</div>
                    <div className="mt-4 text-base font-light">Edit fields and see changes in action, copy code from clicking below button.</div>
...
function InputLabelBox({label, name, inputType, defaultValue, select, textarea, required, min, max, numbers, placeholders, onChange,description}) {
    ...
    return (
      <div className="flex flex-col items-start w-full gap-2 py-3">
        <label className="flex items-center gap-1 px-3 text-xs font-light">
          {label}
        ...
        {draggableState && (
            <div className="flex flex-col items-start w-full gap-2 py-3">
            <label className="flex items-center gap-1 px-3 text-sm">
              Set Initial X-Position of the ChatBox
            </label>
            <div className="px-3 text-xs font-light">This positioning determines where the chat component will first be present when draggable is set to true</div>
            <input
              className="bg-[#202020] px-6 text-[#dbdfe6] w-full max-w-[500px] rounded-2xl py-3 bg-transparent border-[#3d3d3de0] border"
              type="number"
              name="x"
